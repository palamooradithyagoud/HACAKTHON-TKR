...
try:
    from backend.routers import dashboard, ai_mentor, learning, resume, practice, profile, faculty
except ModuleNotFoundError:
    from routers import dashboard, ai_mentor, learning, resume, practice, profile, faculty
